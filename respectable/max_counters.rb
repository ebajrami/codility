...
#
# Write a function: def solution(n, a) that, given an integer N and a non-empty zero-indexed array A consisting of M
...
def solution(n, a)
  ...
  a.each do |item|
    ...
    maxCounter = counters[index] if counters[index] > maxCounter
  end
